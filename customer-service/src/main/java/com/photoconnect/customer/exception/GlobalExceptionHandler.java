...
import com.photoconnect.customer.dto.ErrorResponse;
import com.photoconnect.customer.security.CorrelationIdServletFilter;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDomain(CustomerDomainException ex, HttpServletRequest req) {
